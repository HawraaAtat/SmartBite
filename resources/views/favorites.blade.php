            ...
            <div class="row g-3">
                ...
                <div class="col-12 col-sm-6">
                    <div class="dz-wishlist-bx">
                        ...
                        <div class="dz-info">
                            <div class="dz-head">
                                <h6 class="title"><a href="{{ route('favorites.show', $recipe['id']) }}">{{
                                        $recipe['title'] }}</a></h6>
                            </div>
                            <ul class="dz-meta">
                                <li>
                                    ...
                                    $calories = $isFavorite ? Auth::user()->favorites->where('recipe_id',
                                    $recipe['id'])->first()->calories : null;
                                    @endphp
                                    <i class="heart-icon fa fa-heart{{ $isFavorite ? ' active' : '' }}"
                                        style="color: {{ $isFavorite ? 'red' : 'black' }};"
                                        data-recipe-id="{{ $recipe['id'] }}" data-calories="{{ $calories }}"></i>
                                </li>
                            </ul>
                        </div>
                    </div>
