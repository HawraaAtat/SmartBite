                    ...
                    <ul>
                        <li>
                            <span style="display: flex; align-items: center;">Personal Details
                                <a href="{{route('edit-profile')}}" style="margin-left: 5px;">
                                    <svg enable-background="new 0 0 461.75 461.75" height="15"
                                        viewBox="0 0 461.75 461.75" width="24" xmlns="http://www.w3.org/2000/svg">
                                        <path
                        ...
                        <li>
                            <div class="icon-bx">
                                ...
                                <svg class="svg-primary" stroke-width="1.8432" fill="none" width="24" height="24"
                                    ...
                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                        ...
                                        stroke="##04764E" stroke-width="10"></path>
                                </svg>
                        ...
                        <span style="display: flex; align-items: center;">Change Your Password
                            <a href="{{route('edit-password')}}" style="margin-left: 5px;">
                                <svg enable-background="new 0 0 461.75 461.75" height="15" viewBox="0 0 461.75 461.75"
