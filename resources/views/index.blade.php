            ...
            <div class="header-content">
                <div class="left-content">
                    <div class="info"> @if(Auth::check()) <p class="text m-b10">Hello</p>
                        <h3 class="title">{{ Auth::user()->first_name }}</h3> @else <p class="text m-b10">YOU ARE NOT LOGGED IN.</p> @endif
                    </div>
                </div>
                ...
                <form id="filterForm" action="{{route('dashboard')}}" method="GET">
                    ...
                    <div class="row" id="contentArea">
                        <div class="col-12">
                            <div class="card-body">
                                <!-- Offcanvas Top -->
                                <button class="btn btn-primary btn-block mb-2" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasTop" aria-controls="offcanvasTop">Filter</button>
