            ...
            <div class="header-content">
                ...
                <div class="right-content d-flex align-items-center gap-4">
                    <a href="notification.html" class="notification-badge font-20 badge-active">
                        <svg width="30" height="30" viewBox="0 0 24 24" class="svg-primary" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path
                ...
                <form id="filterForm" action="{{route('dashboard')}}" method="GET">
                    ...
                    <div class="search-box">
                        <div class="input-group input-radius input-rounded input-lg">
                            <input type="text" name="search" placeholder="Search beverages or foods"
                                class="form-control">
                    ...
                    <div class="row" id="contentArea">
                        <div class="col-12">
                            <div class="card-body">
                                <!-- Offcanvas Top -->
                                <button class="btn btn-primary btn-block mb-2" type="button" data-bs-toggle="offcanvas"
                                    data-bs-target="#offcanvasTop" aria-controls="offcanvasTop">Filter</button>
                                <div class="offcanvas offcanvas-top" tabindex="-1" id="offcanvasTop"
                                    ...
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-sm btn-danger light"
                                            style="margin-right: 3px;" data-bs-dismiss="offcanvas">Close</button>
