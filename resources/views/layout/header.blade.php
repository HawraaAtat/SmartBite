...
<head>
    ...
    <meta name="keywords" content="food, health, recommendation, app, personalized, customized, nutrition, diet, mobile, pwa, android, ios">
    ...
    <meta property="og:image" content="{{ asset('assets/images/app-logo/Smart Bite Rounded Logo.png') }}">
    ...
    <meta name="twitter:image" content="{{ asset('assets/images/app-logo/Smart Bite Rounded Logo.png') }}">
    <meta name="twitter:card" content="summary_large_image">
    <!-- Mobile Specific -->
    <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, minimum-scale=1, minimal-ui, viewport-fit=cover">
    <!-- Favicons Icon -->
    <link rel="shortcut icon" type="image/x-icon" href="{{ asset('assets/images/app-logo/Smart Bite Rounded Logo.png') }}">
    <!-- PWA Version -->
