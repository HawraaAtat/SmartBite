            ...
            <div class="dz-authentication-area">
                ...
                <div class="account-section">
                    <form class="m-b30" action="{{ route('login') }}" method="POST">
                        ...
                        <p class="form-text">Forgot Password? <a href="{{ route('forget.password') }}"
                                class="link ms-2">Reset Password</a></p>
                    </form>
                    <div class="text-center account-footer">
                        <p class="text-light">Dont have any account?</p>
                        <a href="{{ url('signup') }}" class="btn btn-secondary btn-lg btn-thin rounded-xl w-100">CREATE
                            AN ACCOUNT</a>
                    </div>
                </div>
            </div>
